...
# Place all CSV files to be analyzed under one folder
# Then place this script under the same folder
# Then cd to this folder and run script in terminal
# Aggregated info will be printed in standard I/O
